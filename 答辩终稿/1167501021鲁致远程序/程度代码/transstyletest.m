...
%风格增益的计算抽象画
% G1=sqrt(P1^2/((P7)+0.1));G2=sqrt(P2^2/((P8)+0.1));G3=sqrt(P3^2/((P9)+0.1));
%   G4=sqrt(P4^2/((P10)+0.1));G5=sqrt(P5^2/((P11)+0.1));G6=sqrt(P6^2/((P12)+0.1));
%  G1=sqrt(P1/((P7+P1)*20));G2=sqrt(P2/((P8+P2)*20));G3=sqrt(P3/((P9+P3)*20));
%   G4=sqrt(P4/((P10+P4)*20));G5=sqrt(P5/((P11+P5)*20));G6=sqrt(P6/((P12+P6)*20));
%%%%%铅笔画
  G1=sqrt((P1^2)/((P7+P1+0.05)));G2=sqrt((P2^2)/((P8+P2+0.05)));G3=sqrt((P3^2)/((P9+P3+0.05)));
  G4=sqrt((P4^2)/((P10+P4+0.05)));G5=sqrt((P5^2)/((P11+P5+0.05)));G6=sqrt((P6^2)/((P12+P6+0.05)));
%   G1=sqrt((P1^2)/((P7+P1)));G2=sqrt((P2)/((P8+P2)));G3=sqrt((P3)/((P9+P3)));
%   G4=sqrt((P4)/((P10+P4)));G5=sqrt((P5)/((P11+P5)));G6=sqrt((P6)/((P12+P6)));
% G1=sqrt((P1)/((P7+P1)));G2=sqrt((P2)/((P8+P2)));G3=sqrt((P3)/((P9+P3)));
%   G4=sqrt((P4)/((P10+P4)));G5=sqrt((P5)/((P11+P5)));G6=sqrt((P6)/((P12+P6)));
%   
%%test
...
RGB_F=imlincomb(1,RGB_06, 1.5,RGB_17, 2,RGB_28,2.5,RGB_39,1.5,RGB_410,1,RGB_511);
imshow(RGB_F,[])  ,title('1:2:3:4:3:2');
figure('NumberTitle', 'off', 'Name', '增益百分比倒数');
RGB_T=imlincomb(0.007/(G1^2),RGB_06, 0.007/(G2^2),RGB_17, 0.007/(G3^2),RGB_28,0.007/(G4^2),RGB_39,0.007/(G5^2),RGB_410,0.007/(G6^2),RGB_511);
imshow(RGB_T,[])  ,title('1/(G1:G2:G3:G4:G5:G6)');
figure('NumberTitle', 'off', 'Name', '增益比递增');
RGB_O=imlincomb(1,RGB_06, 2,RGB_17, 3,RGB_28,4,RGB_39,5,RGB_410,6,RGB_511);
imshow(RGB_O,[])  ,title('1:2:3:4:5:6');
figure('NumberTitle', 'off', 'Name', 'G');
...
figure('NumberTitle', 'off', 'Name', '10G');
RGB_X=imlincomb(10*G1,RGB_06, 8*G2,RGB_17, 6*G3,RGB_28,4*G4,RGB_39,2*G5,RGB_410,1*G6,RGB_511);
imshow(RGB_X,[])  ,title('10G1:10:8');
figure('NumberTitle', 'off', 'Name', '12G');
RGB_A=imlincomb(12*G1,RGB_06, 10*G2,RGB_17, 8*G3,RGB_28,6*G4,RGB_39,4*G5,RGB_410,2*G6,RGB_511);
imshow(RGB_A,[])  ,title('12G1:10:8');
figure('NumberTitle', 'off', 'Name', '8G');
RGB_T=imlincomb(8*G1,RGB_06, 6*G2,RGB_17, 4*G3,RGB_28,4*G4,RGB_39,4*G5,RGB_410,2*G6,RGB_511);
imshow(RGB_T,[])  ,title('8G1:10:8');
%  
